...
public class StringUtil {
    ...
    public Result determine(@RequestBody Map<String,?> params) throws ErrorMessage {
        String str = String.valueOf(params.get("str"));
        if (StringUtils.isAllBlank(str)) throw new ErrorMessage(ErrorEnum.COMMON_ERROR.getCode(), ErrorEnum.COMMON_ERROR.getMessage());
    ...
    public Result stringContro(@RequestBody Map<String,?> params) throws ErrorMessage {
